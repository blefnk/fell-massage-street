...
- **🚀 Live Demo**: [fell-massage-street.vercel.app](https://fell-massage-street.vercel.app/en)
- **💙 Discord**: [discord.gg/Pb8uKbwpsJ](https://discord.gg/Pb8uKbwpsJ)
- **📚 Docs**: [docs.reliverse.org](https://docs.reliverse.org/fell-massage-street)
...
1. `git clone https://github.com/blefnk/fell-massage-street.git`
2. `cd fell-massage-street`
3. `bun i`
